...
import com.yangjinjing.cms.commen.FileResult;

/** 
* @author 作者:杨今敬
* @version 创建时间：2019年12月19日 下午7:59:45
* 类功能说明 
*/
@Controller
@RequestMapping("file")
public class FileController {
	...
	public String manager(HttpServletRequest request,
		...
		//跟目录路径，可以指定绝对路径  比如  /var/www/attached/
		String rootPath = picRoot+"/";
		
		//跟目录URL，可以指定绝对路径，比如http://www.4399.com
		...
		String dirName = dir;
		if(dirName != null){
			if(!Arrays.<String>asList(new String[]{"gif","jpg","png","bmp"}).contains(dirName)){
