	...
	action="/article/complain" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
		   <label >投诉类型</label>
		   		&nbsp;&nbsp;&nbsp;<input type="checkbox" name="complainOption" value="1"> 标题夸张
		   		  &nbsp;&nbsp;&nbsp;<input type="checkbox" name="complainOption" value="2">与事实不符 
		   		  &nbsp;&nbsp;&nbsp;<input type="checkbox" name="complainOption" value="3"> 疑似抄袭
		 	 <form:errors path="complainOption" cssStyle="color:red"></form:errors>
		  </div>
